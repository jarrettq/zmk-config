/*
 * Placeholder logo for the RIGHT half of the Corne split keyboard.
 *
 * ===== IMAGE FORMAT =====
 ...
 *   5. Replace logo_right_map[] pixel data below (starting at offset 8)
 *
 * ===== PIXEL ENCODING =====
...
static const uint8_t logo_right_map[1232] = {
    /* Palette */
...
const lv_img_dsc_t logo_right = {
    .header.always_zero = 0,
    .header.w = 140,
    .header.h = 68,
    .header.cf = LV_IMG_CF_INDEXED_1BIT,
    .data_size = sizeof(logo_right_map),
    .data = logo_right_map,
};
